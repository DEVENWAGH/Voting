...
const VoteActivitySchema = new mongoose.Schema(
  {
    ...
    // V3 privacy audit: keccak256(electionId, candidateId, voterNullifier, salt)
    // Verifiable by the relay but opaque without knowing the salt + nullifier
    ballotHash:      { type: String },
    // V3 re-voting: true if this vote replaced a previous choice
